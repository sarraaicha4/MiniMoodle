...
public class BaseMoodleActivity extends AppCompatActivity {
    ...
    protected void setupBottomNavigation(String activePage) {
        ...
        assignments.setOnClickListener(view -> openScreen(CoursesActivity.class));
        grid.setOnClickListener(view -> openScreen(CoursesActivity.class));
        ...
        tintNavButton(assignments, "courses".equals(activePage));
        tintNavButton(grid, "courses".equals(activePage));
